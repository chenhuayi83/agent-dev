...
**面试题轨道状态(v1.2 起)**:基础库 01–10 十组已于 2026-08-19 一次性建成,覆盖 agent 基础、上下文工程、MCP 与协议、多智能体、记忆、评估可观测、安全注入、生产化、框架选型、编码代理实战。**日常运行不再新增题组**,改为在 P4 做增量维护(见 P4 第 6 条)。仅两种情况重新占用 P2 槽位:用户点名要新题组;或出现全新的一级主题(新协议/新范式成为独立考点)。
