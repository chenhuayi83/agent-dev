...
| P | 主题 | 为什么 | 预计实验 | 入队日期 |
|---|---|---|---|---|
| 1 | 2026-08 Agent 开发全景基线扫描 | 建立"什么算新"的参照系;补齐模型知识 2026-02→08 空白 | 否 | 2026-08-19 |
| 2 | Claude Agent SDK 深研:架构 / agent loop / 与 Claude Code 的关系 | 本系统运行其上,吃狗粮优先 | 是:最小 agent + 自定义 tool | 2026-08-19 |
| 3 | MCP 2026 现状:spec 演进 / 生态规模 / 最佳实践 | 事实上的工具接入标准 | 是:最小 MCP server | 2026-08-19 |
| 4 | 上下文工程系统化:compaction / isolation / cache 策略 | agent 质量的第一性瓶颈 | 否 | 2026-08-19 |
